package com.lfc.mytestnight.widget;
...
import com.lfc.mytestnight.MyTestApp;
...
public final class PreferenceUtil {
  ...
  public static String getString(String key, String defValue) {
    ...
    return PreferenceManager.getDefaultSharedPreferences(MyTestApp.getInstance())
  ...
  public static void putStringProcess(String key, String value) {
    ...
    SharedPreferences sharedPreferences = MyTestApp.getInstance()
